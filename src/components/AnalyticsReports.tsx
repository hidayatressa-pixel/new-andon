      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className={`border rounded-3xl p-5 shadow-sm transition-colors ${
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-500 dark:text-neutral-500 font-semibold">Tiket</span>
          </div>
        ...
        <div className={`border rounded-2xl p-4 flex flex-wrap items-center justify-between gap-3 shadow-sm transition-colors ${
          ...
          <div className="relative flex-1 min-w-[220px]">
            ...
            <input
              ...
              placeholder="Cari tiket, lini, deskripsi..."
          ...
          >
            ...
            <option value="machine_breakdown">Mesin Rusak</option>
            <option value="material_shortage">Material Kurang</option>
            <option value="quality_defect">Kualitas</option>
            <option value="maintenance_tooling">Tooling</option>
            <option value="supervisor_call">Leader Support</option>
            <option value="safety_alert">K3 / Safety</option>
          </select>
        </div>
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className={`border-b text-[11px] font-bold uppercase ${
                  ...
                  <th className="py-3 px-4">Lini & Stasiun</th>
                  <th className="py-3 px-4">Kategori & Masalah</th>
                  <th className="py-3 px-4">Waktu Panggilan</th>
                  <th className="py-3 px-4">Status & Penanganan</th>
                  <th className="py-3 px-4">Akar Masalah (Root Cause)</th>
                </tr>
              </thead>
